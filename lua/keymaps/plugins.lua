...
-- Tmux/Vim resizing
map({ "n" }, "<C-h>", "<Cmd>TmuxResizeLeft<CR> | <CMD>lua require('bufferline.api').set_offset(vim.api.nvim_win_get_width(require('nvim-tree.api').tree.winid() or 0))<CR>", { remap = true, silent = true, desc = 'Resize Neovim pane horizontally' })
map({ "n" }, "<C-j>", "<Cmd>TmuxResizeDown<CR> | <CMD>lua require('bufferline.api').set_offset(vim.api.nvim_win_get_width(require('nvim-tree.api').tree.winid() or 0))<CR>", { remap = true, silent = true, desc = 'Resize Neovim pane vertically' })
map({ "n" }, "<C-k>", "<Cmd>TmuxResizeUp<CR> | <CMD>lua require('bufferline.api').set_offset(vim.api.nvim_win_get_width(require('nvim-tree.api').tree.winid() or 0))<CR>", { remap = true, silent = true, desc = 'Resize Neovim pane vertically' })
map({ "n" }, "<C-l>", "<Cmd>TmuxResizeRight<CR> | <CMD>lua require('bufferline.api').set_offset(vim.api.nvim_win_get_width(require('nvim-tree.api').tree.winid() or 0))<CR>", { remap = true, silent = true, desc = 'Resize Neovim pane horizontally' })
